 ...
 */
Solucion::Solucion():
	valorActual(UINT_MAX),
	valorSiguiente(UINT_MAX),
	solucionActual(0),
	n(0),
	matrices(0)
{
 ...
 * @param contabilizar Especificar false para no contar el numero de llamadas
 */
...
/**
 * @param contabilizar Especificar false para no contar el numero de llamadas a la funcion objetivo
 */
